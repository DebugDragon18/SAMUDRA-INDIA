...
export function CommunityHero() {
  return (
    <section className="relative h-[50vh] min-h-[300px] overflow-hidden">
      <Image
        src="https://images.unsplash.com/photo-1439405326854-014607f694d7?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3NDE5ODJ8MHwxfHNlYXJjaHw1fHxvY2VhbnxlbnwwfHx8fDE3NTk4MzA5ODF8MA&ixlib=rb-4.1.0&q=80&w=1080"
        alt="Deep blue ocean"
        fill
